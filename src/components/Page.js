  ...
  useEffect(() => {
    ...
    return (    
        <div className={`overflow-hidden min-h-[550px] `}>
            ...
            <div className={`${showWebGL ? 'fixed' : 'hidden' } ${fullscreen ? 'fixed w-full h-full z-30 top-0 left-0' : 'relative max-w-5xl mt-10 mx-auto'}  ${ state ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[5px]'} transform ease-in-out transition-all duration-200 delay-300 px-10`}>
