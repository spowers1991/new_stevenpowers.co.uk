...
const Button = ({ target, text, location }) => {
    return (
            <Link to={target} id="home-link" className="shadow-lg text-sm relative inline-block lg:mt-0 text-l bg-black text-white p-2 lg:p-5 mt-5 text-center font-inter font-bold uppercase group">
                    {text}
